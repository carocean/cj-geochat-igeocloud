package cj.geochat.app.igeocloud.disk.web.rest;

import cj.geochat.ability.api.annotation.ApiResult;
import cj.geochat.ability.minio.INetDiskService;
import cj.geochat.ability.util.GeochatException;
import cj.geochat.app.igeocloud.disk.rest.ISystemDiskRestfull;
...
@RestController
@RequestMapping("/api/v1/igeocloud/system")
@Api(tags = {"系统云盘"})
@RefreshScope
@Slf4j
public class SystemDiskRestfull extends AbstractIGeocloudRestfull implements ISystemDiskRestfull, InitializingBean {
    @Autowired
    ...
    @PreAuthorize("hasAuthority('igeocloud:system:readonly')")
    @Override
    ...
    @PreAuthorize("hasAnyAuthority('igeocloud:system:writeonly','igeocloud:system:readwrite')")
    ...
    @PreAuthorize("hasAnyAuthority('igeocloud:system:readwrite','igeocloud:system:write')")
    ...
    @ApiResult
    @PreAuthorize("hasAuthority('igeocloud:system:delete')")
